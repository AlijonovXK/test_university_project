    ...
    private static void userMenu(User loggedUser) throws ExecutionException, InterruptedException {
        while (true) {
            ...
            Runnable runnable = () -> {
                ...
                transActionService.showAll(transActionHistory, cardService.getCardById(CardId));
            };
            ...
            switch (userIpnut) {
                ...
                case 2 -> {
                    cardService.showUserCardsMains(loggedUser.getId());
                    System.out.print("Enter the card id : ");
                    Integer cardId = scInt.nextInt();
                ...
                case 4 -> {
                    ...
                    if (sendMoney) {
                        TransActionHistory transActionHistory =
                                new TransActionHistory(cardService.getCardById(fromCardId), cardService.getCardByNumber(cardNumber), amount);
